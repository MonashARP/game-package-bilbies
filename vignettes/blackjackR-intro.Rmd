...
-   Aces are special: they count as 11, but automatically switch to 1 if counting as 11 would cause a bust.

**Player’s Turn:**
-   Players can choose to hit (take another card) or stand (keep their hand).
-   The turn continues until the player stands or the hand value exceeds 21 (bust).

**Auto/Smart Player Logic:**
-   Automated players stop hitting when they reach or exceed a threshold (e.g. 17).

**Dealer’s Turn:**
-   The dealer must hit until their hand total is at least 17.
-   A “smart” dealer version can also consider the player’s total before deciding.

**Game Result:**
-   If the player busts, the dealer wins.
-   If the dealer busts, the player wins.
-   If neither busts, the higher hand total wins.
-   Ties result in a "push" — no winner.

...
-   Andy Tran: Team leader, built core functions and extension to single and multiple players.
...
-   Andy Tran: Built main `vctr` logic and functions; `vctr` related unit test, documentation and design vignette.  
